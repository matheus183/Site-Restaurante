...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1><b>RESTAURANTE Olivier Leflaive Restaurant</b></h1>
<table border=0>

    <tr>
        <td rowspan="2" width="498px" height="100"><img src="img/Olivier Leflaive Restaurant.jpg" width="500px" heigth="100px"></td>
        <td width="300px" heigth="80px"><img src="img/Olivier Leflaive Restaurant1.jpg" width="300px" height="335px"></td>
        <td><img src="img/Olivier Leflaive Restaurant2.jpg" width="300px" height="335px"></td>
        <td width="300px" heigth="100px"><img src="img/Olivier Leflaive Restaurant3.jpg" width="250px" height="335px"></td>
    </tr>
...
<div class="holder">
  ...
  <div class="imagem" data-title="">
    <H3>LOCALIZAÇÃO</H3><p>
    <font family="arial"><b>Rua jesephina morais santos 155, São Paulo, Estado de São Paulo 666-66666 Brasil</b></font>
  </div>
  ...
  <font family="arial"><b>FAIXA DE PREÇO:
    ...
    REFEIÇÕES<p>
     Almoço, Jantar,Festas</b></font>
    
  </div>

  <div class="imagem" data-title="">
  <H3>CONTATO</H3><p>
  <B>(55)11-951778612</B><P>
    <b>E-mail: Oliver_leflaiver_restaurant@gmail.com</b>
