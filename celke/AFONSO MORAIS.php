...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1><b>RESTAURANTE AFONSO MORAIS</b></h1>
<table border=0>

    <tr>
        <td rowspan="2" width="498px" height="100"><img src="img/restaurante4.jpg" width="500px" heigth="100px"></td>
        <td width="300px" heigth="80px"><img src="img/restaurante4.1.jpg" width="300px" height="269px"></td>
        <td><img src="img/restaurante4.2.jpg" width="300px" height="269px"></td>
        <td width="300px" heigth="100px"><img src="img/restaurante4.3.jpg" width="250px" height="269px"></td>
    </tr>
...
<div class="holder">
  ...
  <div class="imagem" data-title="">
    <H3>LOCALIZAÇÃO</H3><p>
    <font family="arial"><b>Rua capital das flores, São Paulo, Estado de São Paulo 799-48911 Brasil</b></font>
  </div>
