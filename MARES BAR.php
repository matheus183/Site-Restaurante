...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1><b>MARES DO BAR</b></h1>
<table border=0>

    <tr>
        <td rowspan="2" width="498px" height="100"><img src="img/bar6.jpg" width="500px" heigth="100px"></td>
        <td width="300px" heigth="80px"><img src="img/bar6.1.jpg" width="300px" height="335px"></td>
        <td><img src="img/bar6.2.jpg" width="300px" height="335px"></td>
        <td width="300px" heigth="100px"><img src="img/bar6.3.jpg" width="250px" height="335px"></td>
    </tr>
...
<div class="holder">
  ...
  <div class="imagem" data-title="">
    <H3>LOCALIZAÇÃO</H3><p>
    <font family="arial"><b>Rua Das Dragoes da real, São Paulo, Estado de São Paulo 13-659-789 Brasil</b></font>
  </div>
