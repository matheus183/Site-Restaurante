...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1><b>RESTAURANTE Le Burgonde</b></h1>
<table border=0>

    <tr>
        <td rowspan="2" width="498px" height="100"><img src="img/Le Burgonde.jpg" width="500px" heigth="100px"></td>
        <td width="300px" heigth="80px"><img src="img/123.jpeg" width="300px" height="280px"></td>
        <td><img src="img/Le Burgonde2.jpg" width="300px" height="280px"></td>
        <td width="300px" heigth="100px"><img src="img/Le Burgonde3.jpg" width="250px" height="280px"></td>
    </tr>
...
<div class="holder">
  ...
  <div class="imagem" data-title="">
    <H3>LOCALIZAÇÃO</H3><p>
    <font family="arial"><b>Av Morumbi 92, são Paulo, Estado de São Paulo 9293-2005 Brasil</b></font>
  </div>
