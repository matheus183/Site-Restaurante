...
<table border=0>
    ...
    <tr>
        <td rowspan="2" width="498px" height="100"><img src="img/bar5.jpg" width="500px" heigth="100px"></td>
        <td width="300px" heigth="80px"><img src="img/bar5.1.jpg" width="300px" height="335px"></td>
        <td><img src="img/bar5.2.jpg" width="300px" height="335px"></td>
        <td width="300px" heigth="100px"><img src="img/5.3.jpg" width="250px" height="335px"></td>
    </tr>
...
<div class="holder">
  ...
  <div class="imagem" data-title="">
    <H3>LOCALIZAÇÃO</H3><p>
    <font family="arial"><b>AV. Jardim Nova mangueira, São Paulo, Estado de São Paulo 32-6597816 Brasil</b></font>
  </div>
