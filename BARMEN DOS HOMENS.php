...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1><b>BARMEN DOS HOMENS</b></h1>
<table border=0>

    <tr>
        <td rowspan="2" width="498px" height="200"><img src="img/bar2.jpg" width="500px" heigth="200"></td>
        <td width="300px" heigth="80px"><img src="img/bar2.1.jpg" width="300px" height="264px"></td>
        <td><img src="img/bar2.2.jpg" width="300px" height="264px"></td>
        <td width="300px" heigth="100px"><img src="img/bar2.3.jpg" width="250px" height="264px"></td>
    </tr>
...
<div class="holder">
  ...
  <div class="imagem" data-title="">
    <H3>LOCALIZAÇÃO</H3><p>
    <font family="arial"><b>Rua jardim dos genes 55, Guarulhos, Estado de São Paulo 75-7367817 Brasil</b></font>
  </div>
