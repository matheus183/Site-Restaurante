...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1><b>BAR DO TADEU</b></h1>
<table border=0>

    <tr>
        <td rowspan="2" width="498px" height="100"><img src="img/bar1.png" width="500px" heigth="100px"></td>
        <td width="300px" heigth="80px"><img src="img/bar1.1.jpg" width="300px" height="335px"></td>
        <td><img src="img/bar1.2.jpg" width="300px" height="335px"></td>
        <td width="300px" heigth="100px"><img src="img/bar1.3.jpg" width="250px" height="335px"></td>
    </tr>
...
<div class="holder">
  ...
  <div class="imagem" data-title="">
    <H3>LOCALIZAÇÃO</H3><p>
    <font family="arial"><b>Rua do fernão dias, Guarulhos, Estado de São Paulo 67-2365781 Brasil</b></font>
  </div>
  ...
  <font family="arial"><b>FAIXA DE PREÇO:
    ...
    ATRATIVOS<p>
    KARAOKE, DANÇA, MUSICA</b></font>
    
  </div>

  <div class="imagem" data-title="">
  <H3>CONTATO</H3><p>
  <B>(55)11-62517861</B><P>
