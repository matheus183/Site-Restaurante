...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1><b>RESTAURANTE Comptoir JOA de Santenay</b></h1>
<table border=0>

    <tr>
        <td rowspan="2" width="498px" height="100"><img src="img/Comptoir JOA de Santenay.jpg" width="500px" heigth="100px"></td>
        <td width="300px" heigth="80px"><img src="img/Comptoir JOA de Santenay1.jpg" width="300px" height="335px"></td>
        <td><img src="img/Comptoir JOA de Santenay2.jpg" width="300px" height="335px"></td>
        <td width="300px" heigth="100px"><img src="img/Comptoir JOA de Santenay3.jpg" width="250px" height="335px"></td>
    </tr>
...
<div class="holder">
  ...
  <div class="imagem" data-title="">
    <H3>LOCALIZAÇÃO</H3><p>
    <font family="arial"><b>Rua LA FUSQUINA DA Maria 60, Guarulhos, Estado de São Paulo 999-54177 Brasil</b></font>
  </div>
  ...
  <font family="arial"><b>FAIXA DE PREÇO:
    ...
    REFEIÇÕES<p>
     Almoço, Jantar, Churrasco</b></font>
  ...
  <H3>CONTATO</H3><p>
  <B>(55)11-8612</B><P>
    <b>Comptoir JOA de Santenay@gmail.com</b>
